...
public class TestRand {
  ...
  public static void main(String[] args) {
    ...
    show(a2);
    a2 = Stream.generate(new Rand.Byte()).limit(SZ + 1).toArray(Byte[]::new);
    show(a2);
    ...
    show(a3);
    a3 = Stream.generate(new Rand.Character()).limit(SZ + 1).toArray(Character[]::new);
    show(a3);
    ...
    show(a4);
    a4 = Stream.generate(new Rand.Short()).limit(SZ + 1).toArray(Short[]::new);
    show(a4);
    ...
    show(a6);
    Long[] a6b = Stream.generate(new Rand.Long()).limit(SZ + 1).toArray(Long[]::new);
    show(a6b);
    a6b = new Rand.Long().array(SZ + 2);
    show(a6b);
    a6 = LongStream.generate(new Rand.Plong()).limit(SZ + 1).toArray();
    show(a6);
    ...
    show(a7);
    a7 = Stream.generate(new Rand.Float()).limit(SZ + 1).toArray(Float[]::new);
    show(a7);
    ...
    show(a8);
    Double[] a8b = Stream.generate(new Rand.Double()).limit(SZ + 1).toArray(Double[]::new);
    show(a8b);
    a8b = new Rand.Double().array(SZ + 2);
    show(a8b);
    a8 = DoubleStream.generate(new Rand.Pdouble()).limit(SZ + 1).toArray();
    show(a8);
    ...
    show(s);
    s = Stream.generate(new Rand.String()).limit(SZ).toArray(String[]::new);
    show(s);
    ...
    show(s);
    s = Stream.generate(new Rand.String(4)).limit(SZ).toArray(String[]::new);
    show(s);
