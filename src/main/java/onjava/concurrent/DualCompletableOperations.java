...
public class DualCompletableOperations {
  ...
  public static void main(String[] args) {
    ...
    // 而 “apply” 和 “combine” 则生成新的
    init();
    showr(
        cfA.applyToEitherAsync(
            cfB,
            w -> {
    ...
    init();
    CompletableFuture<Workable> cfC = Workable.make("C", 0.08), cfD = Workable.make("D", 0.09);
